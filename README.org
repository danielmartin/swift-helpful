...
If you have configured the Swift manuals by calling the ~swift-helpful-configure-manuals~ command, ~swift-helpful~ will
show you information about any Swift keyword or attribute. Let's say you see ~import~ in a Swift program and you want to
know more about how importing modules in Swift works. Simply place the point on top of "import" and invoke
~swift-helpful~ with ~M-x swift-helpful~. The tool will show you a brief snippet of documentation about Swift
